/** 
   ...
   Module defines a uiUploader service and a uploadLink directive. 
 */
...
(function()
{
  ...
  module.service(
    ...
    ["$window", "$q", "$http", "$timeout", function ($window, $q, $http, $timeout)
    {
      ...
      /**
        @description The uiUploader service's implementation.  
        @class
        */
      var service =
      {
        /**
          ...
          @example
              ...
              uiUploader.selectAndUploadFile("api/Uploader", ".txt").then(
                function(data, file) 
                { 
        ...
        /**
          ...
          @example
              ...
              uiUploader.uploadFile("api/Uploader", file, "text").then(
                function(data, file) 
                { 
                  // TODO success handler
                },
